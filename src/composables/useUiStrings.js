...
// layer (group 59) with the Amulets site's own keys overlaid — `galleryAbout`
// and `galleryCredits`, the only two this site owns.
//
// These are legacy content, not website copy: they are generated in the
// inventory-app monorepo (`scripts/viewers/amulets`, `npm run sync-i18n`) and
// vendored here. Do not hand-edit them — the website's own translatable texts
// live in `locales/`, which is what the translator flow edits.
//
